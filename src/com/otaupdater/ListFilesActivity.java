...
public class ListFilesActivity extends ListActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    private static String TAG = "OTAUpdate";
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    alert.setPositiveButton(R.string.alert_install, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            doCommand("mkdir -p /cache/recovery");
                            doCommand("rm -f /cache/recovery/command");
                            doCommand("rm -f /cache/recovery/extendedcommand");
                            if (selectedOpts[0]) {
                                doCommand("echo '--wipe_data' >> /cache/recovery/command");
                            }
                            if (selectedOpts[1]) {
                                doCommand("echo '--wipe_cache' >> /cache/recovery/command");
                            }
                            doCommand("echo '--update_package=/" + Utils.getRcvrySdPath() + "/OTA-Updater/download/" + name + "' >> /cache/recovery/command");
                            doCommand("sync");
                        ...
                        //public void onClick(DialogInterface dialog, int which) {
                            //try {
                                ...
                                //// psw0523 fix
                                //Process p = Runtime.getRuntime().exec("sh -c");
